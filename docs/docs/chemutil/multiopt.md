...
### comparison_grid_radar_plots

```python3
def comparison_grid_radar_plots(
    df,
    objective_columns: List[Union[int, str]],
    df_standard: Optional[pandas.core.frame.DataFrame] = None,
    standard_unique_identifier: Optional[str] = None,
    standard_unique_identifer_column: Optional[str] = None
)
```
...
| reference_properties | List[str] | _description_ | None |
| experimental_properties | List[str] | _description_ | None |
| change | List[str] | _description_ | None |
| number_passing | Optional[int] | _description_. Defaults to None. | None |
...
| return_efficent_set_only | None | (bool): whether to return only the pareto efficent set or not | None |
...
| Type | Description |
|---|---|
| pd.DataFrame | The same as the input data_df with a boolean column appended called `pareto_efficent_set`. If `return_efficent_set_only`<br>True then only the rows of the input data_df which are in the pareto efficent set are retruned |
...
| Name | Type | Description | Default |
|---|---|---|---|
| min_value | float | The minimum value for the plot. Defaults to 0.1. | 0.1 |
| max_value | float | The maximum value for the plot. Defaults to 1.0. | 1.0 |
| objectives | Optional[List[str]] | List of objetcives to use | None |
| filename | str | file name to save to. Defaults to "illustrtaion_idelaized_pareto_front_radar_plot.png". | "illustrtaion_idelaized_pareto_front_radar_plot.png" |
...
### plot_multi_radar_overlay

```python3
def plot_multi_radar_overlay(
    plot_df: pandas.core.frame.DataFrame,
    standard_plot_df: pandas.core.frame.DataFrame,
    y_ticks: List[float],
    y_labels: Optional[List[float]] = None,
    filename: str = 'multi_radar_with_standard.png',
    standard_label: Optional[str] = None,
    ...
    experimental_colour: str = 'r',
    mols_per_row: int = 5,
    experimental_labels: Optional[List[str]] = None,
...
| Name | Type | Description | Default |
|---|---|---|---|
| plot_df | pd.DataFrame | Dataframe to use for plotting query/experimental results | None |
| standard_plot_df | Optional[pd.DataFrame] | Dataframe to use as standard data for comparing the experimenatl data to. Defaults to None. | None |
| y_ticks | Optional[list] | The y tick marks to use if you want the radial scales to match other plots. Defaults to None. | None |
| y_label | Optional[List[float]] | List of y (radial) tick labels to display. Defualts to None. | None |
| filename | str | The filename to save the images to. Defaults to "radar_plot.png". | "radar_plot.png" |
| standard_label | Optional[str] | Fixed label for the standard. Defaults to "Standard". | "Standard" |
| experimental_label | Optional[str] | Fixed label for the experimental. Defaults to "Experimental". | "Experimental" |
| legend_pos | Union[int, str] | position of the legend on the plot. Defaults to "best". | "best" |
| standard_colour | str | The colour to use for the standard. Defaults to "b". | "b" |
| experimental_colour | str | The colour to use for the experimental data. Defaults to "r". | "r" |
| mols_per_row | None | int: The number of molecule to plot in a sub plot row. Defaults to 5. | 5 |
| experimental_label | Optional[str] | List of labels for each row (moleucle) of the experimantal dataframe. Defaults to None. | None |
| standard_labels | Optional[str] | List of labels for each row (moleucle) of the standard dataframe. Defaults to None. | None |
...
| plot_df | pd.DataFrame | Dataframe to use for plotting query/experimental results | None |
| y_ticks | Optional[list] | The y tick marks to use if you want the radial scales to match other plots. Defaults to None. | None |
| y_labels | Optional[List[float]] | List of radial (y) ticks label values. Defaults to None. | None |
| filename | str | The filename to save the images to. Defaults to "radar_plot.png". | "radar_plot.png" |
| experimental_label | Optional[str] | Fixed label for the experimental. Defaults to "Experimental". | "Experimental" |
| legend_pos | Union[int, str] | position of the legend on the plot. Defaults to "best". | "best" |
| experimental_colour | str | The colour to use for the experimental data. Defaults to "r". | "r" |
| mols_per_row | int | The number of molecules to plot per row. Defaults to 5. | 5 |
| experimental_label | Optional[str] | List of labels for each row (moleucle). Defaults to None. | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| df | pd.DataFrame | Data frame that conatins at least the objective columns (can contain more). If the `label_column` or `pareto_eff_col` are set then it should also contain these. | None |
| objective_columns | Union[List[str], str] | The column headers for the objetcive columns, if 'all' it uses all provided columns as the objective columns. Defaults to "all". | "all" |
| label_col | Optional[str] | column header for the column that conatins the molecule labels. If not given no label annotation will be on the plot. Defaults to None. | None |
| filename | Optional[str] | The file to save the plot to. Defaults to "pareto_front.png". | "pareto_front.png" |
| pareto_eff_col | Optional[str] | column header for the column that defines whether a molecule is in the Pareto efficent set (boolean column). Defaults to None. | None |
| offset | float | x and y offset in image units from the point for the labels and arrows. Defaults to 0.02. | 0.02 |
| smiles_column | str | the column that contains smiles strings | None |
| inchi_column | str | the column that contains inchi strings | None |
...
def plot_pareto_front_nd(
    ...
    filename: Optional[str] = 'pareto_nd.png',
    pareto_eff_col: Optional[str] = None,
    summary_plot_type: Optional[str] = 'mean',
    normalization: Optional[str] = 'zscale',
    smiles_column: Optional[str] = None,
    inchi_column: Optional[str] = None,
    consistent_scale: bool = False,
...
| filename | Optional[str] | The file to save the plot to. Defaults to "pareto_front.png". | "pareto_front.png" |
| pareto_eff_col | Optional[str] | column header for the column that defines whether a molecule is in the Pareto efficent set (boolean column). Defaults to None. | None |
| summay_plot_type | Union[str, None] | the summary type mean, min or max of each objective for each set (inefficent and efficent). Defaults to "mean". | "mean" |
| normalization | Optional[str] | string name of normalization method or None to use raw data. Defaults to "zscale". | "zscale" |
| smiles_column | str | the column that contains smiles strings | None |
| inchi_column | str | the column that contains inchi strings | None |
| consistent_scale | bool | whether to use a consistent_scale for zscale axes, these will be the min and max values over the entire dataframe which may make some small changes hard to visualize. Defaults to False. | False |
...
| label_col | Optional[str] | column header for the column that conatins the molecule labels. If not given no label annotation will be on the plot. Defaults to None. | None |
| filename | Optional[str] | The file to save the plot to. Defaults to "pareto_front.png". | "pareto_front.png" |
| pareto_rank_col | Optional[str] | column header for the column that defines whether a molecule is in the Pareto efficent set (boolean column). Defaults to None. | None |
| offset | float | x and y offset in image units from the point for the labels and arrows. Defaults to 0.02. | 0.02 |
| smiles_column | str | the column that contains smiles strings | None |
| inchi_column | str | the column that contains inchi strings | None |
...
| plot_df | pd.DataFrame | Dataframe to use for plotting query/experimental results | None |
| y_ticks | Optional[list] | The y tick marks to use if you want the radial scales to match other plots. Defaults to None. | None |
| y_labels | Optional[List[float]] | List of y (radial) tick labels to display. Defualts to None. | None |
| filename | str | The filename to save the images to. Defaults to "radar_plot.png". | "radar_plot.png" |
| experimental_label | Optional[str] | Fixed label for the experimental. Defaults to "Experimental". | "Experimental" |
| legend_pos | Union[int, str] | position of the legend on the plot. Defaults to "best". | "best" |
| experimental_colour | str | The colour to use for the experimental data. Defaults to "r". | "r" |
...
def radar_plot(
    df: pandas.core.frame.DataFrame,
    objective_columns: Optional[List[Union[int, str]]] = None,
    df_standard: Optional[pandas.core.frame.DataFrame] = None,
    standard_unique_identifier: Optional[str] = None,
    standard_unique_identifer_column: Optional[str] = None,
    y_ticks: Optional[list] = None,
    filename: str = 'radar_plot.png',
    label_column: Union[str, int, NoneType] = None,
    standard_label: Optional[str] = 'Standard',
    experimental_label: Optional[str] = 'Experimental',
    legend_pos: Union[int, str] = 'best',
    show_y_ticks: bool = False,
...
| Name | Type | Description | Default |
|---|---|---|---|
| df | pd.DataFrame | Dataframe to use for plotting query/experimental results | None |
| objective_columns | Optional[List[str, int]] | The columns to use as the objectives if not given assumes all columns are objective columns. Defaults to None. | None |
| df_standard | Optional[pd.DataFrame] | Dataframe to use as standard data for comparing the experimenatl data to. Defaults to None. | None |
| standard_unique_identifier | Optional[str] | Column name in standard dataframe to identify a molecule. Defaults to None. | None |
| standard_unique_identifer_column | Optional[str] | Column name in experimental dataframe to identify a molecule. Defaults to None. | None |
| y_ticks | Optional[list] | The y tick marks to use if you want the radial scales to match other plots. Defaults to None. | None |
| filename | str | The filename to save the images to. Defaults to "radar_plot.png". | "radar_plot.png" |
| label_column | Optional[Union[str, int]] | Column name in experimental and standard  dataframe to give a label a molecule. Defaults to None. | None |
| standard_label | Optional[str] | Fixed label for the standard. Defaults to "Standard". | "Standard" |
| experimental_label | Optional[str] | Fixed label for the experimental. Defaults to "Experimental". | "Experimental" |
| legend_pos | Union[int, str] | position of the legend on the plot. Defaults to "best". | "best" |
| show_y_ticks | bool | Bool True show the radial y_tick values False don't show them. Defaults to False. | False |
| standard_colour | str | The colour to use for the standard. Defaults to "b". | "b" |
| experimental_colour | str | The colour to use for the experimental data. Defaults to "r". | "r" |
...
def radar_sub_plots_pareto_front(
    ...
    mols_per_row: int = 5,
    return_data: bool = True,
    y_ticks: Union[numpy.ndarray, list, NoneType] = None,
    show_y_ticks: bool = False
) -> pandas.core.frame.DataFrame
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| ddf | pd.DataFrame | Data frame that conatins at least the objective columns (can contain more). If the `label_column` or `pareto_eff_col` are set then it should also contain these. | None |
| objective_columns | Union[List[str], str] | The column headers for the objetcive columns, if 'all' it uses all provided columns as the objective columns. Defaults to "all". | "all" |
| filename | Optional[str] | The file to save the plot to. Defaults to "pareto_front.png". | "pareto_front.png" |
| label_col | Optional[str] | The column that defines the molecules labels. | None |
| pareto_eff_col | Optional[str] | column header for the column that defines whether a molecule is in the Pareto efficent set (boolean column). Defaults to None. | None |
| normalization | Union[str, None] | string defining teh normalization method | None |
| legend_pos | str | legend position string for matplotlib | None |
| smiles_column | str | the column that contains smiles strings | None |
| inchi_column | str | the column that contains inchi strings | None |
| consistent_scale | bool | whether to use a consistent_scale for zscale axes, these will be the min and max values over the entire dataframe which may make some small changes hard to visualize. Defaults to False. | False |
| y_ticks | Optional[Union[np.ndarray, list]] | Set of y ticks to use to allow for comparison across sets. Defaults as None. | None |
...
| ddf | pd.DataFrame | Data frame that conatins at least the objective columns (can contain more). If the `label_column` or `pareto_eff_col` are set then it should also contain these. | None |
| objective_columns | Union[List[str], str] | The column headers for the objetcive columns, if 'all' it uses all provided columns as the objective columns. Defaults to "all". | "all" |
| filename | Optional[str] | The file to save the plot to. Defaults to "subplot_pareto_ranks.png". | "subplot_pareto_ranks.png" |
| label_col | Optional[str] | The column that defines the molecules labels. | None |
| pareto_rank_col | Optional[str] | column header for the column that defines a molecules Pareto rank (int column). Defaults to None. | None |
| normalization | Union[str, None] | string defining teh normalization method | None |
| legend_pos | str | legend position string for matplotlib | None |
| smiles_column | str | the column that contains smiles strings | None |
| inchi_column | str | the column that contains inchi strings | None |
...
def radar_summary_plot(
    ...
    filename: Optional[str] = None,
    pareto_eff_col: Optional[str] = None,
    y_ticks: Union[numpy.ndarray, List[float], NoneType] = None,
    show_y_ticks: bool = False,
    legend_pos: Union[int, str] = 0
)
```
...
| df | pd.DataFrame | Data frame that conatins at least the objective columns (can contain more). If the `label_column` or `pareto_eff_col` are set then it should also contain these. | None |
| objective_columns | Union[List[str], str] | The column headers for the objetcive columns, if 'all' it uses all provided columns as the objective columns. Defaults to "all". | "all" |
| normalization | Union[str, None] | The normalization type to use or None to use the raw data. Default is zscale. | None |
| summary_type | str | the type of summary statistic to use out of mean. median, max and min. Default is mean. | None |
| filename | Optional[str] | The file to save the plot to. Defaults to "pareto_front.png". | "pareto_front.png" |
| pareto_eff_col | Optional[str] | column header for the column that defines whether a molecule is in the Pareto efficent set (boolean column). Defaults to None. | None |
| y_ticks | Optional[Union[np.ndarray, List[float]]] | Defined set of y tickmarks values to use | None |
| show_y_ticks | bool | Show z scaled y values. Default is False | None |
| legend_pos | None | (Union[int, str]): where to put the legend see https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.legend.html. Defaults to 0 best. | 0 best |
